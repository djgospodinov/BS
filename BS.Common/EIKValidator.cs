...
namespace BS.Common
{
    public class EIKValidator
    {
        public static bool IsValid(string value)
        {
            ...
            if (value.Length == 9)
                return Validate9(numericValue);

            return Validate13(numericValue);
        }

        private static bool Validate9(int numericValue)
        {
            return true;
        }

        private static bool Validate13(int numericValue)
        {
            return true;
        }
    }
